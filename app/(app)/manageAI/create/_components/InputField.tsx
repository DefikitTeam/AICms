...
import { FieldValues, UseFormRegister, Controller } from "react-hook-form"; // Thêm Controller
...
type InputFieldProps<TFieldValues extends FieldValues = FieldValues> = {
  ...
  control?: any; // Thêm control vào props (từ useForm)
  isSecure?: boolean;
  description?: string;
  type?: string;
      ...
      {type === "boolean" ? (
        <div className="mt-1 flex items-center gap-2 p-2">
          <Controller
            ...
            render={({ field }) => (
              <Switch.Root
                checked={field.value === "true"} // Kiểm tra nếu giá trị là "true"
                onCheckedChange={(checked) =>
                  field.onChange(checked ? "true" : "false")
                } // Chuyển thành "true" hoặc "false"
