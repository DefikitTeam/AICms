  ...
  },
  {
    ...
    value: [
      ...
      },
      {
        ...
        placeholder: "neuralmagic/Meta-Llama-3.1-405B-Instruct-quantized.w4a16",
        isSecure: false,
    ...
    value: [
      {
        ...
        placeholder: "100kb",
        isSecure: false,
        description: "Maximum payload size for Express.js. Defaults to 100kb.",
        type: "text",
      },
    ],
  },
  {
    ...
    value: [
      ...
      },
      {
        ...
        placeholder: "false",
        isSecure: false,
        description: "Flag to use speaker boost in ElevenLabs voice synthesis.",
        type: "boolean",
      },
      {
  ...
  },
  {
    ...
    value: [
      ...
      },
      {
        ...
        isSecure: true,
        description: "Two-factor authentication secret for Twitter account.",
        type: "text",
      },
      {
        ...
        placeholder: "120",
        isSecure: false,
        description: "Polling interval in seconds for Twitter interactions.",
        type: "number",
      },
      {
    ...
    value: [
      {
        ...
        placeholder: "2",
        isSecure: false,
        description: "Minimum interval in minutes between posts. Default: 90.",
        type: "number",
      },
      {
